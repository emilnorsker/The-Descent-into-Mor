...
```
Mud + High Ground:
- Slope becomes treacherous
- Can cause slides
- Natural defense

Oiled + Wall:
- Can't brace properly
- Weapons might slip
- Armor less effective
...
2. Control space with reach
3. Watch footing always

Offensive:
1. Force bad positions
